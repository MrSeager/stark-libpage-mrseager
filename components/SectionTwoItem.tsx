...
export default function SectionTwoItem({ img, category, text }: SectionTwoItemProps) {
    return(
        <div 
            className="flex flex-col gap-2 items-start p-5 border border-[#7b7b7c] rounded-lg aspect-6/4 duration-300
                        hover:border-[#381fd1] hover:scale-102"
        >
            ...
            <h4 className="font-bold text-[23px]">{text}</h4>
        </div>
    );
}